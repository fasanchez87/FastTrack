package com.ingenia.fasttrack.sharedPreferences;
...
//import com.ingenia.fasttrack.beya.beans.Proveedor;
...
public class gestionSharedPreferences
{
  ...
  /*  public void putObject(String key, Object obj) {
    ...
    public HashMap<String,ArrayList<Sede>> getHashMapSedes( )
    {
        Gson gson = new Gson();
        //get from shared prefs
        String storedHashMapString = preferences.getString("HashMapSedes", "oopsDintWork");
        java.lang.reflect.Type type = new TypeToken<HashMap<String, ArrayList<Sede>>>(){}.getType();
        HashMap<String, ArrayList<Sede>> testHashMap2 = gson.fromJson(storedHashMapString, type);
        return testHashMap2;

    }

    public void putHashMapSedes( HashMap<String,ArrayList<Sede>> getHashMapSedes )
    {

        Gson gson = new Gson();
        String hashMapString = gson.toJson(getHashMapSedes);
        //save in shared prefs
        loginPrefsEditor.putString("HashMapSedes", hashMapString).apply();
    }
